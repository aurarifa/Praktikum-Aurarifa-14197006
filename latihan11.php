...
$query=mysqli_query($con,"SELECT * FROM tbl_mata_kuliah WHERE kode_mk='$kode_mk'")or die(mysql_error());
while($data=mysqli_fetch_array($query)){

if(isset($_POST['proses']))
{
$nama_mk= $_POST['nama_mk'];
$query=mysqli_query($con,"UPDATE tbl_mata_kuliah SET kode_mk='$kode_mk', nama_mk='$nama_mk' WHERE kode_mk='$kode_mk'");
